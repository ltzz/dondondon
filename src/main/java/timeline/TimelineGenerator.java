...
public class TimelineGenerator {
    ...
    public static class RowContent {
        ...
        RowContent(String tootId, String userName, String contentText, String contentDate, String favorited, String reblogged, String sensitive, String reblogOriginalUserId){
    ...
    public void timelineAdd(String tootId, String username, String contentText, String contentDate, String favorited, String reblogged, String sensitive, String reblogOriginalUsername){
        if(data != null){
            data.add(new RowContent(tootId,username, contentText, contentDate, favorited, reblogged, sensitive, reblogOriginalUsername));
        }
    }
}
